      ...
      <div className="min-h-screen bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="max-w-7xl mx-auto">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-gray-900 mb-6 sm:mb-8 border-b-2 border-red-600 pb-3">
            ...
            {filteredVideos.length > 0 ? (
              ...
              <div className="text-center py-12 sm:py-16">
                <h2 className="text-xl sm:text-2xl font-bold text-gray-700">No videos found</h2>
            ...
            {loading ? (
              tags.map(tag => (
                <section key={`skeleton-tag-${tag}`}>
                  <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 border-l-4 border-red-600 pl-4">{tag}</h2>
                  {renderSkeletons(3)}
                </section>
              ))
            ) : (
